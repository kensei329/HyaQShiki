...
const en: TranslationsType = {
  ...
  'corporate.description': 'Corporate partnership program for next-generation IT talent development',
  ...
  'curriculum.timeline.days1.title': 'Day 1-10: Building Foundations',
  ...
  'curriculum.timeline.days3.title': 'Day 41-70: Deep Dives by Theme',
  'curriculum.timeline.days3.desc': 'Industry specialization, advanced design, UI/UX, security, API integration, etc.',
  'curriculum.timeline.days4.title': 'Day 71-100: Final Projects and Publication',
  'curriculum.timeline.days4.desc': 'Create multiple culmination apps, publish, share, review, and get certified',
  'curriculum.flow.title': 'Learning Flow',
  'curriculum.flow.phase1.title': 'Foundation Building',
  'curriculum.flow.phase1.period': 'Day 1-14',
  ...
  'curriculum.flow.phase1.point1': 'Generative AI tool operation basics',
  'curriculum.flow.phase1.point2': 'Prompt writing and optimization',
  'curriculum.flow.phase1.point3': 'Development environment setup',
  'curriculum.flow.phase1.point4': 'Building basic web applications',
  'curriculum.flow.phase2.title': 'AI Application Development',
  'curriculum.flow.phase2.period': 'Day 15-28',
  'curriculum.flow.phase2.desc': 'Develop one practical application daily using AI. Gradually increase complexity to build practical skills.',
  'curriculum.flow.phase2.point1': 'AI-powered UI/UX design',
  'curriculum.flow.phase2.point2': 'Backend development optimization',
  'curriculum.flow.phase2.point3': 'API utilization and data integration',
  'curriculum.flow.phase2.point4': 'Building AI-integrated services',
  'curriculum.flow.phase3.title': 'Marketing and Business Models',
  'curriculum.flow.phase3.period': 'Day 29-42',
  'curriculum.flow.phase3.desc': 'Learn how to bring developed apps to market, create marketing strategies, and build revenue models.',
  ...
  'curriculum.flow.phase4.title': 'Scaling and Finances',
  'curriculum.flow.phase4.period': 'Day 43-56',
  ...
  'curriculum.flow.phase5.period': 'Day 57-70',
  'curriculum.flow.phase5.desc': 'Work on a final project that integrates everything you\'ve learned, creating a product that can be brought to market.',
  'curriculum.flow.phase5.point1': 'Completing the business plan',
  'curriculum.flow.phase5.point2': 'Product completion and testing',
  'curriculum.flow.phase5.point3': 'Launch strategy development',
  'curriculum.flow.phase5.point4': 'Pitching to investors',
  'curriculum.approach.title': 'Learning Approach',
  'curriculum.approach.output.title': 'Output-Focused',
  'curriculum.approach.output.desc': 'Gain practical skills by efficiently learning from generative AI while developing applications daily.',
  'curriculum.approach.iteration.title': 'Iteration and Improvement',
  'curriculum.approach.iteration.desc': 'Solidify skills by repeatedly practicing the same patterns and continuously improving based on feedback.',
  'curriculum.approach.community.title': 'Community Learning',
  'curriculum.approach.community.desc': 'Develop multifaceted perspectives through mutual feedback and collaboration with fellow students.',
  'curriculum.approach.mentoring.title': 'Coaching',
  'curriculum.approach.mentoring.desc': 'Assigned mentors provide solid support for everything from learning plan creation to overcoming obstacles.',
  ...
  'curriculum.metrics.apps.desc': 'Develop 100 app features and build a practical portfolio.',
  'curriculum.metrics.monetize.title': 'Monetizable Projects',
  'curriculum.metrics.monetize.desc': 'Aim for at least 10 of your developed apps to be of sufficient quality for monetization.',
  ...
  'sponsor.benefits.benefit1': 'Innovation Creation',
  'sponsor.benefits.benefit1.description': 'New solution perspectives through the latest AI technology and fresh thinking',
  'sponsor.benefits.benefit2': 'Talent Development Support',
  'sponsor.benefits.benefit2.description': 'Improve your employees\' AI literacy and inspire them through student interactions',
  'sponsor.benefits.benefit3': 'Recruitment Pipeline',
  'sponsor.benefits.benefit3.description': 'Early identification of excellent students and relationship building for recruitment',
  ...
  'education.integration.example3': 'AI Integration',
  'education.integration.example4': 'UI/UX Design Improvement',
  ...
  'special.certified.partner.commercialization.description': 'Priority support for commercialization and implementation of excellent solutions developed by students.',
  ...
  'partner.testimonials.position2': 'HR Director, Global Innovation Inc.',
  'contact.partnership.flow.title': 'Partnership Process',
  'contact.partnership.flow.step1': 'Company Registration',
  ...
  'contact.partnership.flow.step5': 'Deliverable Submission',
  'contact.partnership.flow.step6': 'Feedback',
  'contact.partnership.flow.company.form': 'Company Registration',
  'contact.partnership.flow.company.form.desc': 'Register your company information through our dedicated form. Please share your basic requirements and challenge overview at this stage.',
  'contact.partnership.flow.online.meeting': 'Online Meeting',
  'contact.partnership.flow.online.meeting.desc': 'Hold an initial meeting with a coordinator to discuss your company\'s needs, challenge details, and specific direction for collaboration.',
  'contact.partnership.flow.project.registration': 'Project Registration',
  'contact.partnership.flow.project.registration.desc': 'Determine specific project content and adjust it to be appropriate as a student challenge. Non-disclosure agreements can be signed as needed.',
  'contact.partnership.flow.mentoring': 'Mentoring',
  'contact.partnership.flow.mentoring.desc': 'During the project period, company representatives can provide advice and direction checks to students as needed.',
  'contact.partnership.flow.deliverable': 'Deliverable Submission',
  'contact.partnership.flow.deliverable.desc': 'After project completion, deliverables are submitted and a report meeting is held. Results are confirmed through student presentations and Q&A.',
  'contact.partnership.flow.feedback': 'Feedback',
  'contact.partnership.flow.feedback.desc': 'After project completion, feedback is collected from both companies and students to improve future projects. Ongoing collaboration is also considered.',
  
  // Philosophy missing values
  'philosophy.educational.title': 'Educational Philosophy',
  'philosophy.educational.slogan': '10x Creativity with AI',
  'philosophy.educational.desc': 'We provide education that maximizes human creativity through AI utilization. Technology has value only when it can be mastered, and making that happen is our mission.',
  'philosophy.practice.title': 'Practical Learning',
  'philosophy.practice.desc': 'By actually working hands-on and creating applications, you gain real skills.',
  'philosophy.intensive.title': 'Intensive Learning',
  'philosophy.intensive.desc': 'Through concentrated learning in a short period, you efficiently acquire skills that can be immediately applied in practical work.',
  'philosophy.community.title': 'Community',
  'philosophy.community.desc': 'We value an environment where like-minded colleagues learn from and inspire each other.',
  'philosophy.values.practical.title': 'Focus on Practical Skills',
  'philosophy.values.practical.desc': 'We prioritize practical skills over knowledge, focusing on developing abilities that can be actually used.',
  'philosophy.values.continuity.title': 'Continuous Growth',
  'philosophy.values.continuity.desc': 'We provide the mindset and environment for continuous growth, not just temporary learning.',
  ...
  'philosophy.vision.short.desc': 'Train 3,000 next-generation developers nationwide to increase digital innovation leaders.',
  'philosophy.vision.medium.title': 'Medium-term Vision',
  'philosophy.vision.medium.desc': 'Expand educational programs throughout Asia to build a network of innovators across borders.',
  ...
  'certification.certificate.format': 'Certificate Distribution Format',
  'certification.certificate.cycle': 'Certification Cycle',
  'certification.certificate.renewal': 'Renewal Fee',
  'certification.certificate.expiration': 'Renewal Deadline & Expiration Rules',
...
export const LanguageProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Function to get certification fees with proper language handling
  const getCertificationFees = (lang: Language): CertificationFee[] => {
    return [
      ...
      {
        rank: lang === 'en' ? 'Certification Renewal' : '資格更新料',
        fee: '8,800円',
        passRate: '-',
        renewal: lang === 'en' ? 'Common for all ranks' : 'すべてのランク共通'
      }
    ];
  };
